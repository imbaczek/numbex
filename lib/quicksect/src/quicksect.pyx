...
cdef class Feature:
    ...
    """
    cdef public long long start, stop, strand
    cdef public object info
    cdef public object name
    cdef public object chr

    def __cinit__(self, long long start, long long stop, long long strand=0, object chr=None, object name=None, object info=None):
...
cpdef long long distance(Feature f1, Feature f2):
    """\
...
cdef class IntervalNode:
    ...
    cdef public long long start, stop
    ...
    def neighbors(self, Feature f, long long n=1, long long max_dist=25000):
        cdef list neighbors = []
    ...
    cpdef left(self, Feature f, long long n=1, long long max_dist=25000):
    ...
    cpdef right(self, Feature f, long long n=1, long long max_dist=25000):
    ...
    def upstream(self, Feature f, long long n=1, long long max_dist=25000):
    ...
    def downstream(self, Feature f, long long n=1, long long max_dist=25000):
